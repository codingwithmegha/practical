...
Bank b1= new Bank(46758,"Sana",7000.67,22);	
Bank b2= new Bank(49671,"Kiran",5400.67,21);	
Bank b3= new Bank(98709,"Tanvi",4000.67,23);	
Bank b4= new Bank(10101,"Rahul",8000.67,27);	
Bank b5= new Bank(12677,"jishan",9000.67,25);
//array list
